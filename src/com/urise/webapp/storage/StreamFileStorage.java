...
public class StreamFileStorage extends AbstractStorage<File> {
    ...
    protected void doUpdate(Resume r, File file) {
        try {
            choiceSerializer.doWrite(r, new BufferedOutputStream(new FileOutputStream(file)));
        } catch (IOException e) {
    ...
    protected Resume doGet(File file) {
        try {
            return choiceSerializer.doRead(new BufferedInputStream(new FileInputStream(file)));
        } catch (IOException e) {
